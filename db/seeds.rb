...
p1 = Photo.create(title: "", description: "", image_url: "http://res.cloudinary.com/db1ywnpgj/image/upload/v1495176797/photo-1476111021705-ac3b3304fe20_innk8p.jpg", user_id: u.id )
p2 = Photo.create(title: "", description: "", image_url: "http://res.cloudinary.com/db1ywnpgj/image/upload/v1495176797/photo-1466853817435-05b43fe45b39_qltxrr.jpg", user_id: u.id )
...
p4 = Photo.create(title: "", description: "", image_url: "http://res.cloudinary.com/db1ywnpgj/image/upload/v1495174740/derek-liang-260743_rlbygu.jpg", user_id: u.id)
p3 = Photo.create(title: "", description: "", image_url: "http://res.cloudinary.com/db1ywnpgj/image/upload/v1495176797/photo-1494587416117-f102a2ac0a8d_kifq1n.jpg", user_id: u.id )
